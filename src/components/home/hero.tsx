...
function Hero(): JSX.Element {
  return (
    <section className='relative z-10 bg-gray-100 text-black-tone sm:pt-6 pt-20 pb-20'>
      <FadeIntoView as={Container} className='flex flex-col'>
        ...
        <Typography
          as='h1'
          className='sm:text-10xl 2xl:text-12xl text-15vw text-gray-900 font-black pb-10'>
          {heroData.title}
        </Typography>
