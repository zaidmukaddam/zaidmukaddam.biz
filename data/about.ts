const aboutData = {
  ...
  thirdSection: {
    ...
    bio: {
      intro: [
        'Background',
        "Hi, my name is Zaid Altaf Mukaddam. I'm a web developer based in Mumbai, IN. Initially I had no knowledge of any concept related to the tech and/or digital field, started from the bottom and slowly aquired all my current skills by thoroughly following a well designed self learning path. My speciality is fullstack development with the ability to take on a general idea and carry it on from initial planning all the way to the market.",
      ],
      spareTime: [
        'Spare Time',
      ...
      hobbies: [
        'Hobbies',
        "I love to play games, read books, watch movies, listen to music, and play video games. I also love to travel and explore new places.",
      ],
      mantra: [
        'Mantra',
        'Life is a journey, and I am always looking for new things to learn and explore. I believe in the power of learning and I believe in the power of sharing.',
      ],
    },
  },
};
